...
const ProductCard = () => {
    ...
    // but after refereshing the page the cart agian becomes 0 
    // so what we can dop is  stotre your data in local storage
    // i want whenever my page loads it shows thew data
    // for that i will use useEffect Hook
